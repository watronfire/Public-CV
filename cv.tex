...
\name{Nathaniel L.}{Matteson}
\position{Graduate Student{\enskip\cdotp\enskip}Genomic Epidemiology}
%\address{235, World Cup buk-ro, Mapo-gu, Seoul, 03936, Republic of Korea}

\mobile{+1 (505) 412-5228}
\email{natem@scripps.edu}
%\dateofbirth{January 1st, 1970}
\homepage{www.nmatteson.com}
\github{watronfire}
% \gitlab{gitlab-id}
...
\boldname{Matteson}{Nathaniel}{L} % Specify the author's name
...
\makecvfooter
  {\today}
  {Nathaniel L. Matteson~~~·~~~Curriculum Vitae}
  {\thepage}
